...
def create_kpi_card(title: str, icon_class: str, id_value: str, color_hex: str, tooltip_text: str) -> dbc.Card:
    return dbc.Card(
        dbc.CardBody([
            html.Div([
...
def create_insight_icon(icon_class: str, bg_color_hex: str) -> html.Div:
    return html.Div(
