...
2. [Technical Information](https://www.google.com/search?q=%232-technical-information)  
3. [Function and Class Descriptions](https://www.google.com/search?q=%233-function-and-class-descriptions)  
   * [Module: src.data_loader](https://www.google.com/search?q=%23module-srcdata_loader)  
   * [Module: src.charts](https://www.google.com/search?q=%23module-srccharts)  
   * [Module: src.callbacks](https://www.google.com/search?q=%23module-srccallbacks)  
   * [Module: src.helpers](https://www.google.com/search?q=%23module-srchelpers)  
4. [Testing and Validation](https://www.google.com/search?q=%234-testing-and-validation)  
5. [Handling Unexpected Situations](https://www.google.com/search?q=%235-handling-unexpected-situations)
...
3. Run the dependency installation command in the project root:  
   `poetry install`
...
* **Purpose:** Private helper function for applying uniform visual style to all charts  
