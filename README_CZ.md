...
Cílem této práce bylo vytvořit interaktivní analytický dashboard pro vizualizaci dat o prodeji ojetých vozů na německém trhu (AutoScout24 dataset). Aplikace slouží k rychlé orientaci v tržních trendech, analýze cenotvorby a identifikaci klíčových faktorů ovlivňujících cenu vozidel.
...
Dashboard je rozdělen do logických sekcí pomocí karet (Tabs), což zajišťuje přehlednost a snižuje kognitivní zátěž uživatele.
...
1. **Sunburst Chart (Market Hierarchy):**  
...
1. **Scatter Plot (Price vs. Mileage):**  
   * *Typ:* Bodový graf.  
...
Aplikace je napsána v jazyce **Python** s využitím frameworku **Dash** (nadstavba nad Flask a React.js) a knihovny **Plotly** pro vizualizace.
...
4. Aplikace bude dostupná na adrese http://127.0.0.1:8050.
